...
# app = FastAPI(title="ML Model API with GitHub", version="1.0.0")

# # GitHub raw content URL
# MODEL_URL = "https://raw.githubusercontent.com/SagarChhabriya/ml-model-api/main/model/model.joblib"
...
# @app.get("/")
# async def root():
#     return {"message": "API with GitHub-hosted model!"}
...
#         "class": ["setosa", "versicolor", "virginica"][prediction[0]]
#     }